...
.nav{
    ...
    z-index: 100;
    @apply w-full text-gray-300 border border-slate-300 max-w-sm sm:max-w-md rounded-sm sm:rounded-full h-11 sm:h-14 fixed right-0 left-0 mx-auto mt-6 sm:mt-10 shadow-lg flex items-center justify-center
}
.nav.new-bg{
    a{
